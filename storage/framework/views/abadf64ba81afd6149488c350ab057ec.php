...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li><a href="<?php echo e(route('index')); ?>" class="nav-link px-2 link">Головна</a></li>
        <li><a href="<?php echo e(route('product.list')); ?>" class="nav-link px-2">Товари</a></li>
        <li><a href="<?php echo e(route('product.index')); ?>" class="nav-link px-2">Списки</a></li>
      </ul>
                    ...
                    <div class="col-md-3 text-end nomarker d-flex center">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                    <a class="nav-link" href="<?php echo e(route('login')); ?>"><button type='button' class='btn btn-outline-primary me-2'>Увійти</button></a>
                            <?php endif; ?>

                            <?php if(Route::has('register')): ?>
                                    <a class="nav-link" href="<?php echo e(route('register')); ?>"><button type='button' class='btn btn-primary'>Реєстрація</button></a>
                            <?php endif; ?>
                        <?php else: ?>
                            <a href='profile.php'>
                              <button type='button' class='btn btn-primary me-2'><?php echo e(Auth::user()->name); ?></button></a>
...
</html><?php /**PATH D:\Skins\AdobePNG\For use\Art\Shops\WebDev\laravel\blogprogress\resources\views/layouts/main.blade.php ENDPATH**/ ?>